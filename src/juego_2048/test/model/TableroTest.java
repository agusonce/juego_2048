...
class TableroTest {
	...
	public void doLeftCasoSinSuma() {
		...
		int[][] matriz= new int[][] {{0,2,0,0},
									 {0,4,2,0},
									 {4,2,0,0},
									 {2,4,2,4}};

		List<int[]> resultadoEsperado = new ArrayList<>(Arrays.asList(
			    new int[]{0, 0, 2},
			    new int[]{1, 0, 4},
			    new int[]{1, 1, 2},
			    new int[]{2, 0, 4},
